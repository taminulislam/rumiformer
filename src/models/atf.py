...
Three input streams, all projected to D=256:
  ...
  Stream B (Overlay features): Stage-4 features from RumiFormer segmentation branch
...
class AsymmetricThermalFusion(nn.Module):
    ...
    Args:
        ...
        stage4_channels: number of channels in RumiFormer Stage-4 features
    """
    ...
    def forward(self, binary_mask: torch.Tensor,
        ...
        Args:
            ...
            stage4_features: (B, 512, H/32, W/32) from RumiFormer
